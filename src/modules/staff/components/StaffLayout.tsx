...
export function StaffLayout({ venueId, children }: StaffLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white p-6 font-sans text-black antialiased">
      <StaffHeader />

      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-6 pt-4">
        <h2 className="text-center font-serif text-3xl font-normal tracking-wide text-black sm:text-4xl">
