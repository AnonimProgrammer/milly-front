          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-black/10 bg-black/[0.02] text-sm text-black transition-all focus:border-black/30 focus:ring-1 focus:ring-black/20 outline-none disabled:cursor-not-allowed disabled:opacity-60"
              />
            </div>
